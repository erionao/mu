...
<body ng-controller="JobDetailsCtrl">
            ...
            <div class="row">
                <div class="col-md-12 title_details_page">
                    ...
                    <div class="col-md-6 " style="margin-top: 20px;">
                        <button class="edit_content_btn" ng-click="updateJob(job.id, job)">Edit</button> <button class="cancel_content_btn">Cancel</button>
                    </div>
                </div>
