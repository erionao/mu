...
<!-- End Of navigationbar  -->
    ...
    <div id="page-wrapper" class="add_projects_page">
        <div class="container-fluid">
            ...
            <div class="row">
                <button class="btn btn-success pull-left" ng-click="go('/job/add')">Add New Job</button>
                <div class="col-md-12 table_section">
                    <table ng-if="jobs" datatable="" class="row-border hover">
                        <thead>
                        <tr>
                            <th>Title</th>
                            <th>Created_at</th>
                        ...
                        <tr ng-repeat="job in jobs">
                            <td style="cursor:pointer" ng-click="edit(job.id)"><%job.title%></td>
                            <td style="cursor:pointer" ng-click="edit(job.id)"><%job.created_at%></td>
                            <td style="cursor:pointer" ng-click="edit(job.id)"><%job.updated_at%></td>

                            <td><a href="">
                                    <button class="edit_btn_ta" ng-click="edit(job.id)"><i class="fa fa-pencil"
                                                                                            aria-hidden="true"></i>&nbsp;Edit
                                    </button>
                                </a>
                                <button class="delete_btn delete_btn_ta" ng-click="delete(job.id)"><i
