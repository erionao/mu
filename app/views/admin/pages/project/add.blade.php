    ...
    {{--</div>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 title_details_page">
                            <label>Title of the Project:</label>
                            <input type="" ng-model="project.title" name="">
                            <label for="sel1">Project Type:</label>
                            <select class="form-control"ng-model="project.type_id" >
                            <option ng-repeat="type in types" value="<%type.id%>"><%type.name%></option>
                            </select>
                            ...
                            <div class="col-md-6 " style="margin-top: 20px;">
                                <button class="edit_content_btn spi" ng-click="saveProject(project)">Save</button> <button class="cancel_content_btn">Cancel</button>
                            </div>
