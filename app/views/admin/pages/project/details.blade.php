        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 title_details_page">
                    ...
                    <input type="" value="<%project.title%>" name="">
                    <label>Content of the Project:</label>
                    <div ckeditor="options" ng-model="project.content" ready="onReady()"></div>

                    <div class="col-md-6 " style="margin-top: 20px;">
                        <button class="edit_content_btn">Edit</button> <button class="cancel_content_btn">Cancel</button>
                    </div>
                ...
                <h5>Project Photos:</h5>
                    <div class="col-md-3 container" ng-repeat="image in project.images">
                        <img ng-src="{{URL::to('/uploads/projects/')}}/<% image.image %>" class="image img-responsive" >
                        <div class="middle">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="flavicon" class="btn btn-primary" ng-click="addImage(project.id, file)">Add</button>
            </div>
        </div>
