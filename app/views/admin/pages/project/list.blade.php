...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="add_projects_page">
        <div class="container-fluid">
            ...
            <div class="row">
                <button class="btn btn-success pull-left" ng-click="go('/projects/add')">Add New Project</button>
                <div class="col-md-12 table_section">
                    <table ng-if="projects" datatable="" class="row-border hover">
                        <thead>
                        <tr>
                            <th>Title</th>
                            <th>Type</th>
                        ...
                        <tr ng-repeat="project in projects">
                            <td style="cursor:pointer" ng-click="edit(project.id)"><%project.title%></td>
                            <td style="cursor:pointer" ng-click="edit(project.id)"> <%project.type.name%></td>
                            <td style="cursor:pointer" ng-click="edit(project.id)"><%project.created_at%></td>
                            <td style="cursor:pointer" ng-click="edit(project.id)"><%project.updated_at%></td>

                            <td><a href="">
                                    <button class="edit_btn_ta" ng-click="edit(project.id)"><i class="fa fa-pencil"
                                                                                               aria-hidden="true"></i>&nbsp;Edit
                                    </button>
                                </a>
                                <button class="delete_btn delete_btn_ta" ng-click="delete(project.id)"><i
